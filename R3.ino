...
const int Sleep12 = 140;//117;
const int Sleep23 = 30;//70
const int Sleep34 = 160; //26
int Sleep45 = closed5;
...
void loop() {
  ...
  //If signal exist move the box from Conveyor to storage orange
  if (Signal1State == 1) {
    
      pickUpConveyorToStorageBlue(75, 0, 155); //(location of Conveyor, ? , location of Container)
      delay(1000);      
  }
  
  //If signal exist move the box from Conveyor to storage blue
  else if (Signal2State == 1) {
    
      pickUpConveyorToStorageOrange(75, 0, 155); //(location of Conveyor, ? , location of Container)
      delay(1000);
...
void pickUpConveyorToStorageBlue(int pickUp, int correction01, int dropTable) {

  //Pick up from conveyor and move the storage blue
  ...
  //go to conveyor
  moveServos(pickUp, 47, 94, 103, nc);
  delay(100);
...
//  ServoSpeedSlow = 50;
  ...
  moveServos(dropTable, 80, 80, 70, nc);
  delay(100);
...
void pickUpConveyorToStorageOrange(int pickUp, int correction01, int dropTable) {

  //Pick up from conveyor and move the storage orange
...
//  ServoSpeedSlow = 50;
  ...
  //go to the container position
  moveServos(dropTable, 30, 150, 70, nc);
  delay(100);
  
  moveServos(nc, nc, nc, nc, opened5);
  delay(50);

  moveServos(nc, nc, nc, 180, nc);
  delay(50);
  
  moveServos(nc, 140, 30, 180, nc);
  delay(50);
